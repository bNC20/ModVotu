...
public class BazucaItem extends VotucraftModElements.ModElement {
	@ObjectHolder("votucraft:bazuca")
	public static final Item block = null;
	public BazucaItem(VotucraftModElements instance) {
		super(instance, 18);
	}
